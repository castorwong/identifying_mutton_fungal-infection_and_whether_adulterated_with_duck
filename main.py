...
from UI.open_camera import Ui_MainWindow
import cv2
from PyQt5.Qt import *
import os
from Scripts.predict_mobilenetv3 import predict_result
from paddle_online.judge_functionlized import judge_Bat
...
class Open_Camera(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def loadphoto(self):
        global fname
        self.textBrowser.clear()
        fname, _ = QFileDialog.getOpenFileName(self, '请您选择图片', "C:/", 'Image files(*.jpg *.JPG *.gif *.png*.bmp)')
    ...
    def judge(self):
        result_str=judge_Bat(file_path)
        self.textBrowser.append(" ")
